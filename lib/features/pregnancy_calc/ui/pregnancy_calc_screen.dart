...
// ─────────────────────────────────────────────────────────────────────────────
class BC {
  static const Color primary = C.darkBlue;
  static const Color primaryLight = C.darkBlue;
  static const Color primaryDeep = C.darkBlue;
  static const Color primaryFrost = C.lightBlue;
  static const Color primaryPale = C.lightBlue;
  static const Color gradStart = C.darkBlue;
  static const Color gradMid = C.darkBlue;
  static const Color gradEnd = C.darkBlue;
  static const Color gradLightEnd = C.lightBlue;
  static const Color coral = C.coral;
  static const Color coralLight = C.coralLight;
  static const Color lavender = C.darkBlue;
  static const Color lavenderLight = C.lightBlue;
  static const Color mint = C.mint;
  static const Color mintLight = C.mintLight;
  static const Color gold = C.gold;
  static const Color goldLight = C.goldLight;
  static const Color notify = C.darkBlue;
  static const Color notifyLight = C.lightBlue;
  static const Color white = C.white;
  static const Color offWhite = C.bgPage;
  static const Color grayBg = C.bgPage;
  static const Color border = C.lightBlue;
  static const Color borderLight = C.lightBlue;
  static const Color textDark = C.darkBlue;
  static const Color textMid = C.textLight;
  static const Color textLight = C.textLight;
  static const Color success = C.success;
  static const Color successLight = C.successBg;
  static const Color error = C.error;
  static const Color errorLight = C.errorLight;
}
...
class _PregnancyCalculationScreenState extends State<PregnancyCalculationScreen>
  ...
  void initState() {
    ...
    if (appState.hasPregnancyData && appState.lnmp != null) {
      _lnmpDate = appState.lnmp;
      _method = 0;
    }
    _notifySet = appState.pregnancyRemindersEnabled;
  }
  ...
  void _toggleNotify() async {
    HapticFeedback.mediumImpact();
    if (_notifySet) {
      await NotificationService.disablePregnancyReminders(appState);
      if (mounted) setState(() => _notifySet = false);
    } else {
      await NotificationService.enablePregnancyReminders(appState);
      if (mounted) {
        setState(() => _notifySet = true);
            ...
            Positioned(
              ...
              child: Container(
                ...
                gradient: LinearGradient(
                  ...
                  colors: [C.lightBlue, C.lightBlue.withOpacity(0)],
                ),
              )),
            ),
            SafeArea(
